...
def custom_converter_tostr(initial_data_set : dict,
    ...
    optimize_param_name = ("_h_" + "_".join(str(np.round(list(initial_data_set['height'].values()), 3)).
                            replace("[", "").
                            replace("]", "").
                            replace(",", "").
                            split())
                            ...
                            ('_d_' + '_'.join(str(np.round(list(initial_data_set['distance'].values()), 3)).
                            replace("[", "").
                            replace("]", "").
                            replace(",", "").
                            split()) 
                            ...
                            ('_f0_' + '_'.join(str(np.round(list(initial_data_set['focus_0'].values()), 3)).
                            replace("[", "").
                            replace("]", "").
                            replace(",", "").
                            split())
